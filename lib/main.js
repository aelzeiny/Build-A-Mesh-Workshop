...
import DrawOnlyInterface from './draw_only_interface';
...
import WekGenerator from './wek_generator';
...
class Main {
  ...
  next1() {
    ...
    this.interface = new DrawOnlyInterface(this.clipperMap);
  ...
  regenWek() {
    const wekGenerator = new WekGenerator(this.width, this.height, GRID);
